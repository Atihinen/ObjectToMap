...
@route('/v1/categories', method=['OPTIONS', 'GET'])
def get_categories():
    data = []
...
@route('/v1/categories/<id>', method="GET")
def get_category(id):
...
@route('/v1/categories/<id>', method=['OPTIONS', 'DELETE'])
...
@route('/v1/categories/<id>', method=['OPTIONS', 'PUT'])
...
@route('/v1/categories/new', method=['OPTIONS', 'POST'])
def new_category():
...
@route('/v1/fire-hydrants/new', method=["OPTIONS", "POST"])
...
@route('/v1/fire-hydrants/<id>', method=["OPTIONS", "DELETE"])
...
@route('/v1/fire-hydrants/<id>', method=["OPTIONS", "PUT"])
...
@route('/v1/fire-hydrants/<id>', method=['OPTIONS', 'GET'])
